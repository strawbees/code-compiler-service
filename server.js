...
const throng = require('./utils/throng')
/**
...
const start = (workerId) => {
	...
	server.listen(port)
	console.log(`Server (${workerId}): Serving on port ${port}`)
}
/**
 * Index
 *
...
/**
 * Starts the server in a cluster
 *
 * Initialize the Database cleanup routine, only on the master process
 **/
// throng({
